...
var PanelView = Backbone.View.extend({
    ...
    events: {
        ...
        'click #chromeperfectpixel-pasteBtn': 'createLayerFromClipboard'
    },


    createLayerFromClipboard: function(){
        chrome.extension.sendMessage({ type: PP_RequestType.GrabImageFromClipboard }, function(res) {
            console.log(res)
        });
    },
